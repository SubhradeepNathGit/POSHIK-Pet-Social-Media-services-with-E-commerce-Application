    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Here's what's happening on Poshik today.</p>
            </div>
          </div>
      ...
      <Card>
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h3 className="text-xl font-bold text-gray-800 mb-1">KYC Review Center</h3>
            <p className="text-gray-600 text-sm">Review and approve veterinarian applications</p>
          </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <span className={`status-badge ${vet.medical_doc_url ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
